...
public class DriveTrain extends Subsystem {
	...
	public void setGyroMode(GyroMode gMode) {
		if (gyroMode != gMode) {
			...
			if (gyroMode == GyroMode.off) {
				...
				gyroController.setPID(RobotMap.navP, RobotMap.navI, RobotMap.navD,
						RobotMap.navF);
				...
				CustomPIDController gyroController = m_navController.getPIDController();
				gyroController.setPID(RobotMap.navRateP, RobotMap.navRateI,
						RobotMap.navRateD, RobotMap.navRateF);
	...
	public void rateDrive(double forward, double turn) {
		...
		m_robotDrive.arcadeDrive(m_reversed * forward / m_rateScale,
				turn / m_turnRateScale, false, false);
	}
